 ...
 * @author User
 */
public class IdiomaSistem extends javax.swing.JFrame {

    /**
     * Creates new form IdiomaSistem
     */
    public IdiomaSistem() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/22222.png"))); // NOI18N
        ...
        lblClique.setForeground(new java.awt.Color(255, 102, 204));
    ...
    private void btnBotaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBotaoActionPerformed
       ...
       lblClique.setText(loc.getDisplayLanguage());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IdiomaSistem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IdiomaSistem().setVisible(true);
            }
        });
    }
